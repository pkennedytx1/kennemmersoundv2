            ...
            <div className="content">
                <FadeIn>
                    ...
                    <div className="testamonials">
                        <b style={{fontSize: '18px'}}>John Monroe</b><br/>Head of Post-Production at BL&S
                        <br/><br/>
