    ...
    return(
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="ml-auto">
                ...
                <Nav.Link onClick={toggleIsOn} as={NavLink} eventKey={window.innerWidth < 990 ? 4 : null} to='/contact'><i className="fas fa-comment"></i> Contact</Nav.Link>
                <Nav.Link onClick={toggleIsOn} as={NavLink} eventKey={window.innerWidth < 990 ? 5 : null} to='/testimonials'><i className="fas fa-star"></i> Testimonials</Nav.Link>
            </Nav>
        </Navbar.Collapse>
        </Navbar>
    </>
